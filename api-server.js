...
// Add approval processing endpoint
app.post('/api/workflows/steps/:stepId/approve', express.json(), (req, res) => {
...
app.listen(3002, () => {
  console.log('LeaveBoard API Server running on http://localhost:3002');
  console.log('Frontend CORS enabled for http://localhost:3007');
});